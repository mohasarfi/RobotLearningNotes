...
if __name__ == "__main__":
    ...
    # State : [Gripper postion(3) and openness(1), Object position(3), Object rotation(4) and quaternion(4), Object2 position(3) and quaternion(4), previous frame of all of the above(18) , goal position(3)]
